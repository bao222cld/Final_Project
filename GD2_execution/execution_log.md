...
| TC16-11 | P0 | **Pass** | | image_TC16-01.png | Xác nhận qua ảnh role Interviewer: không thấy nút Add |
| TC16-01 | P1 | **Fail** | BUG-001 | image_TC16-01.png | Thiếu cột "Interviewer"; cột "Result" không tách riêng mà gộp vào Status |
...
| TC16-04 | P1 | **Fail** | BUG-002 | image_TC16-04.png | Message thực tế "No Interview Schedule has been found" không khớp ME008 |
| TC16-05 | P1 | **Blocked** | BUG-003 | image_TC16-05.png | Chặn bởi BUG-003 — không có combo-box "Interviewer" |
| TC16-07 | P1 | **Blocked** | BUG-004 | image_status_dropdown.png | Chặn bởi BUG-004 — thiếu status "New"; 3 status còn lại (Invited/Interviewed/Cancelled) lọc **đúng** |
...
| TC16-16 | P1 | **Fail** | BUG-005 | image_TC16-01.png | Không role nào có icon View ở cột Action |
| TC16-18 | P1 | **Blocked** | — | — | Không có quyền chỉnh dữ liệu test (cần Result bất thường) |
| TC16-19 | P1 | **Fail** | BUG-006 | image_TC16-01.png | Format hiện `DD-MM-YYYY` (gạch ngang) thay vì `DD/MM/YYYY` (gạch chéo) |
...
| TC16-06 | P2 | **Blocked** | BUG-003 | image_TC16-05.png | Không có cột/combo Interviewer |
